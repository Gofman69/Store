...
public class StoreController {
    ...
    public ResponseEntity<?> createProduct(@RequestBody ProductAvailability productAvailability) { // Изменил тип даннхы на ResponseEntity<?>, тем самым возвращаю статус "CREATED"
